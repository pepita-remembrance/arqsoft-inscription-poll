...
class InscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inscription" do
    assert_difference('Inscription.count') do
      post inscriptions_url, params: { inscription: { classroom_id: @inscription.classroom_id, course_id: @inscription.course_id, student_id: @inscription.student_id } }
    end
  ...
  test "should update inscription" do
    patch inscription_url(@inscription), params: { inscription: { classroom_id: @inscription.classroom_id, course_id: @inscription.course_id, student_id: @inscription.student_id } }
